...
export default function WakmenuPage() {
  ...
  const [query, setQuery] = useState(''); const [status, setStatus] = useState('SOOP 연결 중'); const [historyOpen, setHistoryOpen] = useState(false); const [tick, setTick] = useState(0); const [settledCount, setSettledCount] = useState(0)
