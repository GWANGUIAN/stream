...
export default function WakmenuPage() {
  ...
  const [query, setQuery] = useState(''); const [status, setStatus] = useState('연결 준비 중'); const [historyOpen, setHistoryOpen] = useState(false); const [tick, setTick] = useState(0); const [settledCount, setSettledCount] = useState(0)
